  ...
  const layers: LayerConfig[] = useMemo(
    () => [
      ...
      { key: "horns", z: 14, src: assets.horns, color: getColorForLayer("horns", colors) },
      {
        ...
        z: 15,
        src: assets.eyes,
        color: getColorForLayer("eyes", colors),
        mode: "eyes",
      },
      ...
      { key: "jacketB", z: 66, src: assets.jacketB, color: getColorForLayer("jacketB", colors) },
      {
        key: "shoulderA",
        z: 2,
        src: assets.shoulderA,
        color: getColorForLayer("shoulderA", colors),
      },
      {
        key: "shoulderB",
        z: 3,
        src: assets.shoulderB,
        color: getColorForLayer("shoulderB", colors),
      },
      {
        key: "accessoryA",
        z: 70,
        src: assets.accessoryA,
        color: getColorForLayer("accessoryA", colors),
      },
      {
        key: "accessoryB",
        z: 71,
        src: assets.accessoryB,
        color: getColorForLayer("accessoryB", colors),
      },
      {
        key: "accessoryC",
        z: 72,
        src: assets.accessoryC,
        color: getColorForLayer("accessoryC", colors),
      },
      {
        key: "accessoryD",
        z: 73,
        src: assets.accessoryD,
        color: getColorForLayer("accessoryD", colors),
      },
    ],
    [assets, colors]
  );
